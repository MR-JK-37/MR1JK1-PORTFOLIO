  ...
  return (
    <section id="contact" className="section-padding section-lazy">
      <div className="section-max-width">
        <ScrollReveal>
          <p className="eyebrow mb-3">$ netcat --connect</p>
          <h2
          ...
          >
            Get In{" "}
            <span style={{ color: "var(--color-blue)" }}>Touch</span>
          </h2>
        </ScrollReveal>
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12">
          ...
          <ScrollReveal delay={0.1}>
            <div className="space-y-6">
              <a
                href={`mailto:${email}`}
                className="card p-5 flex items-center gap-4 group hover:border-blue/30 transition-all"
                style={{ borderRadius: "var(--radius-card)", textDecoration: "none" }}
              >
                <div
                  className="shrink-0 w-12 h-12 rounded-xl flex items-center justify-center transition-all group-hover:shadow-[0_0_20px_rgba(69,211,255,0.3)]"
                  style={{
                ...
                <div>
                  <p
                    className="font-[family-name:var(--font-mono)] text-text-muted"
                    style={{ fontSize: "0.7rem" }}
                  >
                    email
                  </p>
                  <p className="text-text-primary" style={{ fontSize: "0.9rem" }}>
                    {email}
                  </p>
                </div>
              </a>
              ...
              <a
                href={`tel:${phone}`}
                className="card p-5 flex items-center gap-4 group hover:border-violet/30 transition-all"
                style={{ borderRadius: "var(--radius-card-alt)", textDecoration: "none" }}
              >
                <div
                  className="shrink-0 w-12 h-12 rounded-xl flex items-center justify-center transition-all group-hover:shadow-[0_0_20px_rgba(178,115,255,0.3)]"
                  style={{
              ...
              >
                <div
                  ...
                  style={{
                    ...
                    border: "1px solid rgba(240,166,58,0.2)",
                  }}
                >
                  <svg
                    width="20"
          ...
          <ScrollReveal delay={0.2}>
            <div className="space-y-6">
              <h3
                ...
                style={{ fontSize: "0.85rem", color: "var(--color-violet)" }}
              >
              ...
              <div className="grid grid-cols-1 gap-4">
                {socialLinks.map((link) => (
                  ...
                  >
                    ...
                    <span className="text-text-primary font-medium" style={{ fontSize: "0.9rem" }}>
                      {link.name}
                    </span>
                    <svg
                      className="ml-auto text-text-muted group-hover:text-blue transition-all group-hover:translate-x-1"
                      width="16"
                      height="16"
                      fill="none"
                      viewBox="0 0 24 24"
